...
def upgrade() -> None:
    ...
    sa.Column('created_at_dt', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at_dt', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('content_id', 'chunk_index', name='uq_chunks_content_index')
    )
